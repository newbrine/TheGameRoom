...
public class PlayerShip extends Ship {
	...
	public PlayerShip(Rectangle ship, double screenWidth, double screenHeight) {
		...
		dy = 0;
		this.ship  = ship;
		ship.setFill(new ImagePattern(new Image("file:\\"+System.getProperty("user.dir")+"\\galalite\\player.png",ratioWidth,ratioHeight,false,false)));
	...
	public PlayerShip(Rectangle ship, double screenWidth, double screenHeight, double xCord, double yCord) {
		...
		dy = 0;
		this.ship  = ship;
		ship.setFill(new ImagePattern(new Image("player.png",ratioWidth,ratioHeight,false,false)));
