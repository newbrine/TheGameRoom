...
public class MainController {
	...
	private void setUpBackground() {
		bg1 = new ImageView(getClass().getResource("galalite/larger_bg2.png").toExternalForm());
		bg2 = new ImageView(getClass().getResource("galalite/larger_bg2.png").toExternalForm());
	...
	private void pause() {
		...
		dialog.initOwner((Stage) gamePane.getScene().getWindow());
	...
	private void changeScene(String fxml) {
		   try {
		     Parent pane = FXMLLoader.load(
			   ...
			   gamePane.getScene().setRoot(pane);
